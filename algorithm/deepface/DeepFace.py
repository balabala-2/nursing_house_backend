...
from algorithm.deepface.basemodels import DlibWrapper, Boosting, VGGFace
from algorithm.deepface.extendedmodels import Emotion
from algorithm.deepface.commons import functions, distance as dst, realtime
...
def stream(db_path = '', model_name ='VGG-Face', detector_backend = 'ssd', distance_metric = 'cosine', enable_face_analysis = True, source = 0, time_threshold = 5, frame_threshold = 1):
